...
The raw data for the database is stored at _/dsde/working/somaticDB/master_.  As of the writing of this guide, the ip address of the mongo server that stores the results of MuTest is
...
After installation, the command _mutest_ will now be available. To get help, you can
type::
